<?php
    ...
    $maquina1 = $conexion -> 	query('select * FROM temporal where id_maquina = "M1"');
    $maquina2 = $conexion -> 	query('select * FROM temporal where id_maquina = "M2"');
	$maquina3 = $conexion -> 	query('select * FROM temporal where id_maquina = "M3"');
